...
test("getClassName fonksiyonu Products component'inden silinmiş", () => {
  expect(product.includes('functiongetClassName()')).not.toBe(true);
});

test("Product.css import'u Products component'inden silinmiş", () => {
  expect(product.includes('./Product.css')).not.toBe(true);
});

test("Product component'i styled-components ile doğru şekilde render oluyor.", () => {
  render(<Products />);
...
test("Styled component'ler Products component fonksiyonun dışında tanımlanmış.", () => {
